                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-3 mb-3">
                    ...
                    <div class="form-check">
                        <input type="radio" id="ok" name="state" value="1" class="form-check-input @error('state') is-invalid @enderror">
                        <label for="ok" class="form-check-label">Ok</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="not_ok" name="state" value="0" class="form-check-input @error('state') is-invalid @enderror">
